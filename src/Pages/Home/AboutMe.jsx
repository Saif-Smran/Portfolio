          ...
          <div className="space-y-6">
            <div className={`p-8 rounded-2xl backdrop-blur-sm border transition-all duration-300 ${
              ...
              <p className={`text-lg leading-relaxed mb-6 ${
                ...
                I'm A.H.M. Saif Smran, a passionate and curious developer focused on building modern, efficient, and scalable web applications. 
                With a strong foundation in C/C++ and an ever-growing skillset in JavaScript, I aim to contribute to impactful real-world projects.
              </p>
              <p className={`text-lg leading-relaxed ${
                isDark ? 'text-gray-300' : 'text-gray-600'
              }`}>
                Currently pursuing my CSE degree at IUBAT, I'm constantly learning and exploring new technologies to stay at the forefront of web development.
              </p>
            </div>

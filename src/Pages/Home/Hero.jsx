                    ...
                    <div className="flex-1 space-y-8 text-center lg:text-left">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                                <div className={`flex items-center space-x-2 px-4 py-2 backdrop-blur-sm rounded-full border transition-all duration-300 hover:scale-105 group ${
                                    isDark 
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a
                                href="https://drive.google.com/uc?export=download&id=1_AhEGktY3XXQB5WMJO_t-0krCW_eZrCY"
                                target="_blank"
